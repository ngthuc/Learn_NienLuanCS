...
namespace SudokuN.Controller
{
    class Class11 : Model
    {
        ...
        public override bool feasibleBlock(Number[,] nb, int x, int y, int number, int value)
        {
            ...
            Number[] group1 = { nb[0, 0], nb[0, 1], nb[0, 2], nb[0, 3], nb[0, 4], nb[0, 5], nb[1, 0], nb[1, 1], nb[1, 2], nb[1, 3], nb[1, 4] };
            Number[] group2 = { nb[0, 6], nb[0, 7], nb[0, 8], nb[0, 9], nb[0, 10], nb[1, 5], nb[1, 6], nb[1, 7], nb[1, 8], nb[1, 9], nb[1, 10] };
            Number[] group3 = { nb[2, 0], nb[2, 1], nb[2, 2], nb[2, 3], nb[2, 4], nb[2, 5], nb[3, 0], nb[3, 1], nb[3, 2], nb[3, 3], nb[3, 4] };
            Number[] group4 = { nb[2, 6], nb[2, 7], nb[2, 8], nb[2, 9], nb[2, 10], nb[3, 6], nb[3, 7], nb[3, 8], nb[3, 9], nb[3, 10], nb[4, 10] };
            Number[] group5 = { nb[4, 0], nb[4, 1], nb[4, 2], nb[4, 3], nb[5, 0], nb[5, 1], nb[5, 2], nb[5, 3], nb[6, 1], nb[6, 2], nb[6, 3] };
            Number[] group6 = { nb[3, 5], nb[4, 4], nb[4, 5], nb[4, 6], nb[5, 4], nb[5, 5], nb[5, 6], nb[6, 4], nb[6, 5], nb[6, 6], nb[7,5] };
            Number[] group7 = { nb[4, 7], nb[4, 8], nb[4, 9], nb[5, 7], nb[5, 8], nb[5, 9], nb[5, 10], nb[6, 7], nb[6, 8], nb[6, 9], nb[6, 10] };
            Number[] group8 = { nb[6, 0], nb[7, 0], nb[7, 1], nb[7, 2], nb[7, 3], nb[7, 4], nb[8, 0], nb[8, 1], nb[8, 2], nb[8, 3], nb[8, 4] };
            Number[] group9 = { nb[7, 6], nb[7, 7], nb[7, 8], nb[7, 9], nb[7, 10], nb[8, 5], nb[8, 6], nb[8, 7], nb[8, 8], nb[8, 9], nb[8, 10] };
            Number[] group10 = { nb[9, 0], nb[9, 1], nb[9, 2], nb[9, 3], nb[9, 4], nb[9, 5], nb[10, 0], nb[10, 1], nb[10, 2], nb[10, 3], nb[10, 4] };
            Number[] group11 = { nb[9, 6], nb[9, 7], nb[9, 8], nb[9, 9], nb[9, 10], nb[10, 5], nb[10, 6], nb[10, 7], nb[10, 8], nb[10, 9], nb[10, 10] };
